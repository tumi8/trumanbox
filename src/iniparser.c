...
/*
 ...
 FIXME: Why not use realloc() -- copying may be be necessary all the time!
 */
...
/**
  @brief	Get the string associated to a key and sectioon, return NULL if not found
  @param    d   Dictionary to search
  @param    section Section of ini-file to search for key
  @param    key Key string to look for
  @return   pointer to statically allocated character string, or NULL.

  This function queries a dictionary for a key in a certain section and
  is essentially the same functionality as iniparser_getstr() but with
  an explicit section in the call.
